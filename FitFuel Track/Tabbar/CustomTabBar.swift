...
class CustomTabBar: UITabBar {
    ...
    func MoveplusButtonScreen() {
        ...
        if let newViewController = storyboard.instantiateViewController(withIdentifier: "WorkoutViewController") as? WorkoutViewController {
            print("View controller initialized")
            
            // Find the current navigation controller and push the view controller
            if let topController = UIApplication.shared.windows.first?.rootViewController as? TabBarViewController {
